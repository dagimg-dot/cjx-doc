const Slogan = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center  text-center absolute left-1/2 -translate-x-1/2 text-custom-pink">
      <p className="text-[60px] tracking-[-6.42px] leading-[60px] font-bold maxmd:text-[55px] minmd:text-[50px] smd:text-[47px] maxmd:tracking-[-5.6px] smd:tracking-[-5.3px] ">
